...
const ExternalLinkIcon = React.forwardRef<SVGSVGElement, IconProps>(({
    ...
    <svg className={className} ref={ref} width={width} height={height} viewBox='0 0 24 24' fill={color === 'inherit' ? 'currentColor' : color} version='1.1' xmlns='http://www.w3.org/2000/svg'>
